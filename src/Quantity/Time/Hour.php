 ...
 * 1 h = 60 min = 3600 s
 */
final class Hour implements TimeInterface, QuantityFactoryInterface, ConvertibleInterface, ComparableInterface, CalculableInterface, AutoScalableInterface
{
    ...
    /**
     * Create an Hour quantity from a PHP DateInterval.
     *
    ...
    public static function ofPhpDateInterval(\DateInterval $interval): self
    {
        ...
        $hours = (float) $totalSeconds / 3600;

        return self::of(NumberFactory::create((string) $hours));
    }

    /**
     * @internal Used by the library for conversions and calculations
     *
     * @throws InvalidUnitException If unit is not TimeUnit::Hour
     */
    public static function from(NumberInterface $value, UnitInterface $unit): self
    {
        if (TimeUnit::Hour !== $unit) {
            throw InvalidUnitException::forInvalidUnit($unit, TimeUnit::Hour, self::class);
        }
