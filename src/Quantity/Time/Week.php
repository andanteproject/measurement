 ...
 * Week quantity.
 *
 * 1 wk = 7 d = 168 h = 10080 min = 604800 s
 */
final class Week implements TimeInterface, QuantityFactoryInterface, ConvertibleInterface, ComparableInterface, CalculableInterface, AutoScalableInterface
{
    ...
    /**
     * Create a Week quantity from a PHP DateInterval.
     *
    ...
    public static function ofPhpDateInterval(\DateInterval $interval): self
    {
        ...
        $weeks = (float) $totalSeconds / 604800;

        return self::of(NumberFactory::create((string) $weeks));
    }

    /**
     * @internal Used by the library for conversions and calculations
     *
     * @throws InvalidUnitException If unit is not TimeUnit::Week
     */
    public static function from(NumberInterface $value, UnitInterface $unit): self
    {
        if (TimeUnit::Week !== $unit) {
            throw InvalidUnitException::forInvalidUnit($unit, TimeUnit::Week, self::class);
        }
